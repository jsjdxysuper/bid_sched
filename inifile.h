...
public:
    ...
    CIniFile(){fpini = NULL;}
    CIniFile(string path):m_cPath(path){fpini = NULL;}
    ...
    string GetStrValue(string domain, string key);

    void * IniOpenFile( const unsigned char mode);
    //mode == 0 ֻ  mode > 0 д
